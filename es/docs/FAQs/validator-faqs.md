...
### 3. ¿Cuáles son los requisitos de hardware/software para ejecutar un nodo validador en Core Chain?
...
### 8) 8) ¿Cómo funciona el proceso de elección del validador en Core Chain?
