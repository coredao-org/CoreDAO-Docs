...
4. **Perte de délégation :** les délégateurs peuvent retirer leur soutien si un validateur performe mal ou est fréquemment pénalisé. Cela réduit grandement les récompenses potentielles du validateur.
...
### 8) Comment fonctionne le processus d'élection des validateurs sur la Core Chain ?
...
4. **Formation du groupe de validateurs :** Les **23** validateurs ayant les meilleurs scores hybrides sont sélectionnés pour le tour suivant.
