...
Al delegar CORE a los validadores, los titulares de CORE pueden ayudar a proteger la red y compartir las recompensas del sistema. Consulta la [guía](../stake-and-delegate/delegating-core.md) detallada sobre la delegación de CORE para más información.
...
Al delegar el poder de hash a los validadores, los mineros de BTC pueden ayudar a proteger la red y participar en las recompensas del sistema. Consulta la [guía](../stake-and-delegate/delegating-hash.md) detallada sobre la delegación de hash power para más información.
