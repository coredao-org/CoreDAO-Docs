...
5. **Reclamar Recompensas:** Las recompensas acumuladas en tokens CORE también aparecerán en el [sitio de staking](http://stake.coredao.org/). Las recompensas en tokens CORE estarán disponibles cuando los usuarios conecten sus wallets y pueden reclamarse diariamente. Also, to be eligible to earn rewards, it is required to complete a full staking round (00:00:00 - 23:59:59 UTC).
