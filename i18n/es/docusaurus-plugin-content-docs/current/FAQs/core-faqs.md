...
Siga nuestra guía detallada sobre cómo conectar su billetera MetaMask a las Core [Testnet](../Dev-Guide/core-wallet-config.md) y a [Mainnet](../Dev-Guide/core-mainnet-wallet-config.md).
