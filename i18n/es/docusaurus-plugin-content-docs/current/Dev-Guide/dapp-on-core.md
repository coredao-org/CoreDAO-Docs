...
3. Asegúrese de que su billetera MetaMask tenga tokens de prueba tCORE o tCORE2 para Core Testnet. Consulte [aquí](./core-wallet-config.md) para obtener detalles sobre cómo obtener tokens tCORE o tCORE2 de Core Faucet.
