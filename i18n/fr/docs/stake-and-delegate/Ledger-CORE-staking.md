...
Avez-vous d'autres questions? Consultez la section [FAQs](../FAQs/ledger-core-faqs.md) pour obtenir des réponses aux problèmes courants, du dépannage et des bonnes pratiques.
