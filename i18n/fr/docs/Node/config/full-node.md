...
Pour les nœuds complets sur le réseau de test Core Blockchain Testnet2, les spécifications matérielles minimales suivantes sont recommandées :

    Exigences	Détails
    Stockage	1 To d'espace disque libre, disque SSD, gp3, 8 000 IOPS, débit de 250 Mo/s, latence de lecture <1 ms.
    Processeur	Minimum 4 cœurs de processeur recommandés.
  ...
  <TabItem value="testnet">Pour les nœuds complets sur le réseau de test Core Blockchain Testnet, les spécifications matérielles minimales suivantes sont recommandées :

    Exigences	Détails
    Stockage	1 To d'espace disque libre
    Processeur	4 cœurs de processeur
    Mémoire RAM	8 gigaoctets
    Débit Internet	Connexion Internet à large bande avec des vitesses de téléversement/téléchargement de 5 mégaoctets par seconde.

  </TabItem>
  <TabItem value="mainnet">Pour les nœuds complets sur le réseau  Core Blockchain Mainnet, les spécifications matérielles minimales suivantes sont recommandées :
