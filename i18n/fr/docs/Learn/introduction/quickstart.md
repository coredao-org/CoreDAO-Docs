...
- **[Faucet Core](https://scan.test2.btcs.network/faucet):** approvisionnez votre adresse Testnet avec des tCORE ou tCORE2.

- **[Staking](https://stake.test2.btcs.network/):** Site web de staking de tCORE.
