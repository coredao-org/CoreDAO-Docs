...
<ParamsDetails {...require("./get-token-holder-count-by-contract-address.ParamsDetails.json")} />

<RequestSchema {...require("./get-token-holder-count-by-contract-address.RequestSchema.json")} />

<StatusCodes {...require("./get-token-holder-count-by-contract-address.StatusCodes.json")} />
