...
3. **Élection des validateurs :**
 - Chaque round, qui dure une journée, les validateurs ayant les meilleurs scores hybrides sont élus dans l'ensemble des validateurs.
 - Les 27 validateurs ayant les meilleurs scores sont choisis pour faire partie de l'ensemble des validateurs actifs pour ce round.

4. **Responsabilités des validateurs :**
 - Les validateurs élus sont responsables de produire des blocs et de valider des transactions tout au long du round.
 - Ils travaillent à round de rôle, chacun leur round pour produire des blocs à chaque créneau, avec chaque créneau durant trois secondes.
...
6. **Distribution des Récompenses :**
 - Les validateurs et leurs délégateurs gagnent des récompenses en jetons CORE lorsque les validateurs élus produisent des blocs de manière fiable et sécurisent la blockchain Core.
...
1. **Délégation de Stake:**
 - Les détenteurs de CORE mettent leurs jetons en jeu en les déléguant aux validateurs Core. De même, les détenteurs de Bitcoin mettent leurs jetons en jeu en les verrouillant temporairement sur Bitcoin et en les déléguant aux validateurs Core. L'influence de la délégation sur l'élection des validateurs est proportionnelle au montant mis en jeu.
