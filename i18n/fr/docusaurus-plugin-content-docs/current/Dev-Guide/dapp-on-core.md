...
3. Assurez-vous que votre portefeuille MetaMask dispose de jetons tCORE ou tCORE2 pour le Core Testnet. Référez-vous [ici](./core-wallet-config.md) pour obtenir des jetons tCORE ou tCORE2 depuis Core Faucet.
