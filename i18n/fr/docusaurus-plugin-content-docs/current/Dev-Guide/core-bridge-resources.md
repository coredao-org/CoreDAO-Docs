...
El código base del puente auditado se puede encontrar [aquí](https://github.com/LayerZero-Labs/wrapped-asset-bridge), y aquí está la lista completa de direcciones de contratos de tokens de puente
